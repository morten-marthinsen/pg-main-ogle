...
**These rules are ABSOLUTE. Violation invalidates the entire spawn.**

| Rule | Consequence of Violation |
|------|--------------------------|
| Must verify synthesis won ALL rounds (not just majority) | Spawning unproven methodology |
| Must verify synthesis-critic codification grade (B or higher) | Methodology not ready for codification |
| Must get user approval for methodology name | Unauthorized permanent addition to stable |
| Must create BOTH skill folder AND critic agent | Incomplete methodology, cannot be evaluated |
| Must initialize win record with spawn lineage | Performance tracking broken |
| Must register in synthesis registry | Successful combination undocumented |

---

## 🔒 MANDATORY EXECUTION SEQUENCE

**You MUST follow this exact sequence. Skipping phases invalidates the spawn.**

### PHASE 1: Eligibility Verification
- [ ] Check Arena ledger for current competition
- [ ] Verify synthesis won EVERY round (not just overall)
- [ ] Check synthesis-critic's codification grade (must be B or higher)
- [ ] Produce eligibility check output

**GATE CHECK:** If eligibility fails, STOP. Do not spawn.

### PHASE 2: Combination Formula Extraction
- [ ] Identify Primary methodology (50-60%) with specific frameworks
- [ ] Identify Secondary methodology (25-35%) with specific frameworks
- [ ] Identify Tertiary elements (10-20%) with specific techniques
- [ ] Document integration points and conflict resolutions

**GATE CHECK:** Must have complete formula before requesting name.

### PHASE 3: User Name Request
- [ ] Present combination summary to user
- [ ] Provide suggested names based on methodology character
- [ ] Wait for user to provide methodology name
- [ ] Validate name is unique and file-system safe

**GATE CHECK:** Must have user-approved name before creating files.

### PHASE 4: Skill Folder Generation
- [ ] Create skill folder at ~/.claude/skills/webinar-[name]/
- [ ] Create SKILL.md with methodology definition
- [ ] Create references/index.md with framework quick reference
- [ ] Create references/lineage.md with parent documentation

**GATE CHECK:** Skill folder must be complete before creating critic.

### PHASE 5: Critic Agent Generation
- [ ] Create critic folder at ~/.claude/agents/webinar-[name]-critic/
- [ ] Create AGENT.md with evaluation criteria from all parent methodologies
- [ ] Include integration quality checks specific to this combination

**GATE CHECK:** Critic must exist for methodology to be evaluatable.

### PHASE 6: Record Initialization
- [ ] Create win record at ~/.claude/webinar-arena/win-records/webinar-[name].md
- [ ] Add to Active Stable in ledger.md
- [ ] Add to Lineage Tree in ledger.md
- [ ] Register in synthesis-registry/successful/

**GATE CHECK:** All records must be initialized to complete spawn.
...
## 📋 EXPERT SPAWNER COMPLIANCE SUMMARY

### Signature Element Verification

| Signature Element | Found | Evidence Location |
|-------------------|-------|-------------------|
| Synthesis won ALL rounds verified | ☐ | |
| Codification grade B+ verified | ☐ | |
| User approved methodology name | ☐ | |
| Skill folder + SKILL.md created | ☐ | |
| Critic agent created | ☐ | |
| Win record initialized with lineage | ☐ | |

**Spawn Validity:** [VALID if all checked / INVALID if any unchecked]

---

*webinar-expert-spawner v2.0.0*
*Part of the Webinar Arena System*
```
