...
**System components must feel like help arriving, not tasks assigned.** Six steps can feel like six chores. "One system that guides you" feels like help. When presenting a multi-part system, the reader should feel like the system does the work — not that THEY have a list of things to manage. Position the reader as the beneficiary, not the operator.
