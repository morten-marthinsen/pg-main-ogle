# Patch that relieves pain without drugs

**Source File:** Patch that relieves pain without drugs.pdf
**Conversion Method:** Text Extraction
**Converted:** 1439922082.0
...
V
S
tf-4 friday, January 25, 2008 UlurfirlO Qatlg ^fleyrojrt)
©2007 Media Services S-77I6()HS42‘)R I

# Patch that relieves pain


# without drugs is cleared


# fo r pu b lic use by FOA
...
## Each container has both small Ingredients in the patches penetrate


## and large patches. to the muscle, joints and bones for
...
The doctor told me that I needed surgery for my back but I
...
all.That’s why I was surprised when the PainNOT™ patch actually took
...
I’m going to make sure I keep a supply of PainNOT™ Patches in my
...
relief with these patches stain
in IO minutes.
...
made of rubber which cause dling. Readers who want to
perspiring. obtain PainNOT Patches
Q. How do readers get can get a $20 discount plus
the PainNOT™ Patch? free shipping and handling if
A. They will not be in they order in the next IO days
stores for an extended period. and get the patches for only
In the mean time, readers can $29 a box delivered. There is
order directly from BioTech a strict limit of 3 boxes at the
Research. •' discount price - no excep­
End of interview. tions please. Please see the
PainNOT™ Patches come Special Readers Discount
in a giant size box of 60 Coupon on this page. Those
patches (30 large patches and readers ordering after IO days
30 small patches) for $49 from the date of this publica­
plus $3.95 shipping and han­ tion must pay regular price.
...
The price of a giant size box of PainNOT Patches which
...
dling and pay only $29 delivered if you order within IO
days. There is a strict limit of 3 boxes at the discount price -
no exceptions please.
• To order by phone, call TOLL FREE 1-800-466-7688 Ext.
PNP1854. Place your order by using your credit card. Op­
erators are on duty Monday - Friday 6am - 3am, Saturday
7am - 12 Midnight and Sunday 7am - I lpm, EST.
...
Address
City ' State Zip Code
Number of boxes you want:________
Check Below and sign below to get discount:
I am ordering within IO days of the date of this publica­
tion, therefore I get a $20 discount plus free shipping and
handling and my price is only $29 delivered.
I am ordering after IO days of the date of this publication,
...
Z VISA Z MasterCard Am. Exp./Optima
□ Discover/Novus
Account No.____________________________ Exp. Date /___
Signature____________________________________________
MAIL TO:
BioTech Research Dept. PNP1854
