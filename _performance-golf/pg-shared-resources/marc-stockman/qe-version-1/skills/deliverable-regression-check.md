...
description: Feature regression prevention for updated deliverables (R-17) — compares versions across 8 dimensions with PASS/FLAG/FAIL verdicts
scope: Prevents feature regressions when updating existing deliverables (PDF, PPTX, DOCX, XLSX, images, diagrams, HTML)
trigger: Automatically when revising, updating, or regenerating any existing file
---
