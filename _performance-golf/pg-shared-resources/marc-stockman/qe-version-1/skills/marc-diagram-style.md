...
description: Visual diagram rendering rules for matplotlib/PIL — fonts, layout, colors, self-audit checklist
scope: Visual diagram rendering rules for matplotlib/PIL — fonts, layout, colors, self-audit checklist
trigger: Any request for technical diagrams, architecture graphics, system visualizations
---
