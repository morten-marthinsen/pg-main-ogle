...
scope: Per-query QE pipeline entry point — understand and lock the problem space
trigger: QE pipeline Phase 1 execution, strategic analysis, problem-space locking
---
