...
║  │  See PDP-ENGINE-CLAUDE.md for routing + loading protocol     │        ║
║  └─────────────────────────────────────────────────────────────┘        ║
╚══════════════════════════════════════════════════════════════════════════╝
```
...
**PDP Enhancement Layer:** When LP-00 classifies `page_type = type_b` or `hybrid`, PDP skills (PDP-03 through PDP-16) replace LP skills where PDP diverges. See `PDP-ENGINE-CLAUDE.md` for routing.
