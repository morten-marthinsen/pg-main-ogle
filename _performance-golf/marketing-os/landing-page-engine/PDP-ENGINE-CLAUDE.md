# PDP Enhancement Layer — CLAUDE.md (Router)
...
|------|-------------|----------|
| **PDP-ENGINE-CLAUDE.md** | Every PDP skill execution (you're reading this now) | PDP Laws, routing, skill directory, model assignment |
...
FOR EVERY PDP SKILL EXECUTION:
  1. READ this file (PDP-ENGINE-CLAUDE.md) — you're doing this now
  2. READ the parent LP Engine CLAUDE.md (universal LP laws apply)
...
*For full PDP best practices and Baymard research, see reference/PDP-BEST-PRACTICES-REFERENCE.md. For LP Engine universal rules, see CLAUDE.md.*
