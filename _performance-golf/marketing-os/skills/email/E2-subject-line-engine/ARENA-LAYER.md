...
**Personas:** See [ARENA-PERSONA-PANEL.md](../../ARENA-PERSONA-PANEL.md)

> **Arena Mode:** `generative_full_draft` -- Competitors each generate 5 subject lines using different formula categories. Layer 2 candidates = reference material, not template. See `ARENA-CORE-PROTOCOL.md` for 3-round execution protocol.
...
> **Agent Team Mode:** When Agent Teams enabled, each persona runs as a separate teammate agent with own context. See `ARENA-CORE-PROTOCOL.md` Agent Team Execution Mode.
