...
> **Arena Mode:** `editorial_revision` — Competitors generate REVISIONS of existing copy per identified issues. Per-issue competition. See `ARENA-CORE-PROTOCOL.md` for 3-round execution protocol.
