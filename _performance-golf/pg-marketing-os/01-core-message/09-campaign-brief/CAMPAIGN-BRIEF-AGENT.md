...
| 0 | Input validation + 7 upstream packages loading | haiku | Simple validation and loading |
| 1 | Cross-package synthesis + direction setting | opus | Deep synthesis across 7 upstream packages |
| 2 | Brief generation + voice direction | opus | Creative direction — tone, voice, style |
| 3 | Validation + consistency check | opus | Judgment-heavy coherence evaluation |
...
|---------|------|---------|
| 1.1 | 2026-02-12 | Model Assignment Table: Added Binding Model Assignment Table. Haiku for infrastructure (Pre/0), opus for synthesis/generation/validation (1-3), sonnet for packaging (4). |
| 1.0 | 2026-01-27 | Initial build: Full campaign brief architecture with 4-layer system, 10 coherence dimensions, creative direction engine, threading guide, human review interface. |
