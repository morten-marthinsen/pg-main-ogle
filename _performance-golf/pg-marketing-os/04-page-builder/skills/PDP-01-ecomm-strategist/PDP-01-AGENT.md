...
Analyze the product and determine the strategic blueprint for the entire E-Commerce Copy Engine pipeline. This skill produces the architecture that PDP-02 through PDP-17 execute against. It does NOT write copy -- it classifies, maps, prioritizes, and budgets.
...
- Feature research scope defined for PDP-02 (what capabilities to investigate)
...
**This skill is NOT:**
- A copy writer (that is PDP-02 through PDP-08)
- A page builder (that is 04-page-builder / LP-00)
- A feature namer (that is PDP-02)
- A headline writer (that is PDP-03)
...
**Downstream:** Feeds `ecomm-strategy.yaml` to PDP-02 (Feature Naming), PDP-03 (Hero & Value Prop), PDP-07 (Section Copy), PDP-08 (Micro-Scripts), LP-15 (Assembly)
...
**No Arena Layer:** PDP-01 is a strategic classification skill. Generative competition does not apply to section mapping and word budgeting.
...
**Gate 2:** All active sections have priority ranking (1-N), word budgets set per section, total page word count within bounds (1500-5000 words depending on page type), feature research scope defined for PDP-02. FAIL = any active section missing priority OR word budget OR total exceeds bounds.
...
1. **NEVER write copy** -- PDP-01 produces strategy, not prose.
...
7. **NEVER skip feature research scope** -- PDP-02 depends on this for feature investigation direction.
