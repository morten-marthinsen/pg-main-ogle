...
description: >-
  ...
  Requires PDP-01 (Strategy) and PDP-02 (Feature Package).
---

# PDP-08 — Micro-Script Writer

**Pipeline Position:** Fifth skill in E-Commerce Copy Engine pipeline. Executes after PDP-01 (Strategist) and PDP-02 (Feature Naming). Feeds LP-15 (Assembly).
...
- Scripts use feature names from PDP-02 consistently
...
- `PDP-08-AGENT.md` — Complete orchestration specification (planned)
- `PDP-08-ANTI-DEGRADATION.md` — Quality enforcement rules (planned)
