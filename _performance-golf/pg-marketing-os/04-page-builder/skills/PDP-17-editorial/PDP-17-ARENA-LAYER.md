...
| **Feature Name Consistency** | 10% | Are all PDP-02 feature names used exactly? Zero paraphrasing, shortening, or invention? |
...
| Feature names exact | Yes | PDP-02 match |
...
editorial_arena_rules:
  INPUT: All competitors receive SAME assembled copy from LP-15
  ...
  CONSTRAINT: Feature names from PDP-02 are LOCKED -- cannot be modified
  CONSTRAINT: Proof elements from PDP-07 CANNOT be removed
  CONSTRAINT: Section structure from LP-15 CANNOT be reorganized
