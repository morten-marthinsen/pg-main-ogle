...
**Purpose:** Mobile PDP UX standards for PDP-17 editorial calibration (Mobile-First Lens + Design-Copy Integration Lens)
...
## PDP-17 Calibration Summary

These standards map directly to PDP-17's editorial audit lenses:

| UX Standard | PDP-17 Audit Lens | Key Metric |
|-------------|------------------|------------|
