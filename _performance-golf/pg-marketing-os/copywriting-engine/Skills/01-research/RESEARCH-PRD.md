...
**Related Document:** [[CopywritingEngine/Skills/01-research/MASTER-AGENT]] (Execution Workflow)
...
HARD BLOCKERS (Gate 2.5 — Layer 2.5 → Layer 3):
...
29. ALWAYS self-expand when minimums unmet (up to 3 attempts, then escalate).
...
- [[CopywritingEngine/Skills/01-research/MASTER-AGENT]] - Execution workflow
- [[CopywritingEngine/Skills/01-research/QUALITY-STANDARDS]] - Universal quality framework
