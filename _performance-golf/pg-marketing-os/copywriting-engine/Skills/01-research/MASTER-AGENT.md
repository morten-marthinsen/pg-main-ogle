...
│  4. BEFORE Layer 3 skills: Check GATE 2.5 (must have human approval)         │
│  5. BEFORE Final Handoff: Check GATE 3 (all artifacts must exist)            │
│                                                                               │
...
14. NEVER count a "conditional_pass" as equivalent to "pass" for Layer 1 Quote Volume checks.
15. MUST auto-expand (up to 3 attempts) before escalating to human.
...
- MUST auto-expand (up to 3 attempts) before escalating to human.
...
**Reference:** [[CopywritingEngine/Skills/01-research/RESEARCH-PRD#Section 4.3]] for Layer 3 requirements
...
│   Input: ALL validated artifacts from Layers 1, 2, 2.5, and 3 + research brief
...
**Reference:** [[CopywritingEngine/Skills/01-research/RESEARCH-PRD#Section 5]] for output requirements
