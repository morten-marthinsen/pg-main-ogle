...
**Authority:** This document has EQUAL authority to EMAIL-ENGINE.md and ~system/SYSTEM-CORE.md
...
```
I HAVE READ THIS FILE: SEQUENCE-ASSEMBLER-ANTI-DEGRADATION.md v1.0
I UNDERSTAND: All failure modes, forbidden rationalizations, and gate enforcement rules below.
I WILL: Produce per-microskill output files for every microskill executed.
I WILL NOT: Modify email body text during assembly, reorder emails from the blueprint sequence, or generate new subject lines instead of loading E2 output.
```
