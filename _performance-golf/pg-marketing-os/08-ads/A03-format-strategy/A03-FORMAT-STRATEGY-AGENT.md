...
- Word count limits cascaded for every assignment (from AD-ENGINE.md enforcement table)
...
**Process:**
1. READ `ads/ad-verticals/[vertical].md`
...
2. CASCADE word count constraint from AD-ENGINE.md:

```
WORD COUNT ENFORCEMENT TABLE (BINDING — from AD-ENGINE.md):
...
5. CALCULATE creative refresh requirements (from AD-ENGINE.md benchmarks):
...
These patterns from AD-ENGINE.md and A01 intelligence inform Layer 2 format decisions.
...
### Key Benchmarks (from AD-ENGINE.md and AD-HOOK-TAXONOMY.md)

| Benchmark | Value | Source |
|-----------|-------|--------|
| UGC vs. polished performance gap | UGC outperforms by 15-25% | AD-ENGINE.md |
| Top-performing ad length range | 83% of top ads are 15-30s | AD-ENGINE.md |
| Meta vertical inventory share | 90% is 9:16 | AD-ENGINE.md |
...
| Win rate expectations | 6.6-30% of tested creatives win | AD-ENGINE.md |
| Kill threshold | Cut losers at 3x AOV spend | AD-ENGINE.md |
| Min creatives/week formula | Weekly spend / (3 x AOV) | AD-ENGINE.md |
