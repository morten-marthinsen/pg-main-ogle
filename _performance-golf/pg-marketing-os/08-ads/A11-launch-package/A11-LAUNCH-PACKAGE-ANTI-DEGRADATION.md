...
```
I HAVE READ THIS FILE: A11-LAUNCH-PACKAGE-ANTI-DEGRADATION.md v1.0
I UNDERSTAND: All failure modes, forbidden rationalizations, and gate enforcement rules below.
I WILL: Produce per-microskill output files for every microskill executed.
I WILL NOT: Accept platform specs as "close enough" (platforms reject uploads that do not match exact specs), skip compliance review or accept non-compliant files into the launch package, or deliver ad files without campaign hierarchy, audience strategy, and budget math.
```
...
- Define Phase 1 priority order (hooks first per AD-ENGINE.md)
