...
1. READ: ./ads/A10-pre-launch-scoring/A10-PRE-LAUNCH-SCORING-ANTI-DEGRADATION.md
2. READ: ./ads/A10-pre-launch-scoring/A10-PRE-LAUNCH-SCORING-AGENT.md
...
RULE 6: FATIGUE PREDICTION MUST CITE A01 DATA.
  ...
  a benchmark from AD-ENGINE.md — use it, but also reference campaign-
...
### Creative Lifespan Reference (from AD-ENGINE.md)
