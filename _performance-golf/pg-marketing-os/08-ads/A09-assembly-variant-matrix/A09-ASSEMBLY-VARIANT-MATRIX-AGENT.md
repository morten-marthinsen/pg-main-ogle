...
- `./ads/A07-copy-production/A07-COPY-PRODUCTION-AGENT.md` (upstream copy variants)
- `./ads/A08-visual-video-production/A08-VISUAL-VIDEO-PRODUCTION-AGENT.md` (upstream production assets)
- `./ads/A03-format-strategy/A03-FORMAT-STRATEGY-AGENT.md` (platform specs and format strategy)
...
1. READ: ./ads/A09-assembly-variant-matrix/A09-ASSEMBLY-VARIANT-MATRIX-ANTI-DEGRADATION.md
2. READ: ./ads/A09-assembly-variant-matrix/A09-ASSEMBLY-VARIANT-MATRIX-AGENT.md
