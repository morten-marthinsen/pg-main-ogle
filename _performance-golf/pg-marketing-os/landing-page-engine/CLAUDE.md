# LandingPageEngine — CLAUDE.md (Router)
...
| **PDP-ENGINE-CLAUDE.md** | All PDP skill executions (Type B / Hybrid) | PDP Laws, routing, PDP skill directory, PDP model assignment, Baymard/NLS integration |
...
FOR PDP SKILLS (when page_type = type_b or hybrid):
  17. READ PDP-ENGINE-CLAUDE.md (PDP router — loads before any PDP skill)
  18. READ reference/PDP-BEST-PRACTICES-REFERENCE.md
  19. See PDP-ENGINE-CLAUDE.md for PDP-specific loading protocol
```
...
**When Type B or Hybrid is detected:** LP-00 routes to PDP Enhancement Layer skills. See `PDP-ENGINE-CLAUDE.md` for the complete PDP routing flow, skill directory, and loading protocol.
...
*See PDP-ENGINE-CLAUDE.md for full PDP routing, laws, and loading protocol.*
