...
**Block 1: PURPOSE — 5/5**
ORGANIC-ENGINE.md opens with precise purpose: "produces systematic, platform-native organic content campaigns." Scope boundaries defined (organic only, not paid/email). Output specified (scripts, captions, carousels, threads, visual direction, scheduling, learning loops). Non-goals implicit through engine positioning within marketing-os.
...
- ~system/SPECIMEN-GUIDE.md defines required specimens per skill
- organic/ORGANIC-SKILL-INDEX.md maps teachings per skill (Cialdini, Kane, Godin, Hormozi, etc.)
...
|----------|------------|-------------|-------|
| ORGANIC-ENGINE.md | 32 | 42 | **0.43** |
| ORGANIC-ENGINE-ANTI-DEGRADATION.md | 38 | 15 | **0.72** |
| LLM-ANTI-DEGRADATION-SYSTEM.md | 28 | 18 | **0.61** |
| organic/ORGANIC-SKILL-INDEX.md | 35 | 32 | **0.52** |
| ~system/pipeline-handoff-registry.md | 20 | 18 | **0.53** |
| ORGANIC-ARENA.md | 12 | 25 | **0.32** |
...
- ~system/pipeline-handoff-registry.md defines clean inter-skill data contracts
...
```
Tier 1 (Orchestrator): ORGANIC-ENGINE.md + AGENT.md files
...
- **Orchestration layer:** ORGANIC-ENGINE.md (391 lines), organic/ORGANIC-SKILL-INDEX.md (490 lines), ~system/pipeline-handoff-registry.md (358 lines), LLM-ANTI-DEGRADATION-SYSTEM.md (393 lines), 24 AGENT.md files (~5,500 lines), 24 ANTI-DEGRADATION files (~4,800 lines) = ~11,932 lines
...
```yaml
quality_scores:
  target: marketing-os/organic/ (full engine)
