...
```
I HAVE READ THIS FILE: S04-ANTI-DEGRADATION.md v1.0
I UNDERSTAND: All failure modes, forbidden rationalizations, and gate enforcement rules below.
I WILL: Produce per-microskill output files for every microskill executed.
I WILL NOT: Create content pillars without mapping to audience needs from AIF. Allow function percentages that don't sum to exactly 100%. Skip series architecture or defer it to production.
```
