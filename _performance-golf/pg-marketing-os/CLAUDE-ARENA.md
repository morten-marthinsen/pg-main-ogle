# CopywritingEngine — CLAUDE-ARENA.md
...
**Full Protocol:** `skills/protocols/ARENA-CORE-PROTOCOL.md`
**Persona Specs:** `skills/protocols/ARENA-PERSONA-PANEL.md`
...
### Single-Context Mode = DEGRADED MODE

**Single-context Arena caps at B+ quality. A-grade output requires Agent Teams.**
...
- **Quality ceiling is explicitly acknowledged as B+**
