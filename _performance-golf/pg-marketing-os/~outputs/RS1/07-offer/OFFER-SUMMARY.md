# OFFER-SUMMARY.md — Skill 07: Offer Architecture
...
- **Launch Edition:** Founders 500 — first 500 units individually numbered with signed COA
- **Guarantee:** 30-day conditional (play 3 rounds, full refund if no difference felt)
- **Value Equation Composite:** 8.75/10
- **Differentiation Score:** 9/10
- **Promise Alignment:** 9/10
...
5. Excessive stroke arc → 74-degree lie angle reduces arc
6. Steering/manipulation → Natural pendulum from heavy-end-forward design
7. Identity split → Putting matches ball-striking, resolving the gap
8. Overthinking → Face control handled by physics, mind focuses on line/speed
...
- Type: Conditional
- Duration: 30 days
- Condition: Play 3 rounds
- Language: "Take the RS1 to the course. Play 3 rounds. If your putting doesn't feel measurably different — if you don't feel the face tracking square without your hands fighting it — return it for a full refund."

**Scarcity:**
- Type: Limited supply (genuine)
- Mechanism: Founders 500 Edition — 500 individually numbered units with signed COA
- Enforcement: Real serial numbers 001-500. Future production continues without Founders designation.

**Urgency:**
- Type: Launch window (inventory-driven)
- Mechanism: When 500 units sell through, Founders Edition ends permanently
- No artificial deadlines or countdown timers

---

## 4. Price Architecture

| Comparison | Price | Physics Advantage |
|-----------|-------|-------------------|
...
**CTA Sequence:**
1. "Choose your RS1: Standard ($399) or Upgraded ($429). Founders 500 — individually numbered."
2. "Secure your Founders number. 500 putters. When they're gone, the Founders Edition is gone."
3. "The weight has been in the wrong place your entire putting life. Move it forward. Let it fall."
...
|-----------|-------|
| Dream Outcome | 9/10 |
| Likelihood of Achievement | 8/10 |
| Time Delay (inverted) | 9/10 |
| Effort & Sacrifice (inverted) | 9/10 |
| **Value Equation Composite** | **8.75/10** |
...
**To VSL/Video:**
- Offer section script with two SKUs, price anchoring, Founders 500, guarantee
- Price reveal: Scotty/LAB anchor → RS1 reveal → savings → scarcity → guarantee
- Emotional close: "Move the weight forward. The fight is over."

**To Email:**
- 7-email launch sequence: tease → mechanism → proof → promise → offer → scarcity → consequence
- Subject line angles: Founders numbers, price comparison, guarantee, scarcity

**To Landing Page:**
- Premium branded eCom format (Apple/VanMoof style)
- Two SKU cards, Founders 500 badge, guarantee badge, competitor price comparison
- Key visuals: hero shot, FDB comparison, exploded view, McGinley portrait, COA mockup
