...
├── CLAUDE-CORE.md                         # Inviolable laws — the constitution of this engine
├── CLAUDE-ARENA.md                        # Arena competition protocol
├── CLAUDE-SPECIMENS.md                    # Specimen loading protocol
