...
- `./skills/protocols/PERSONA-VOICE-LOADING-PROTOCOL.md` (System 2 voice calibration)
...
BEFORE ANY A07 EXECUTION:
  ...
  2. READ AD-ENGINE-CLAUDE.md (The 5 Laws, Variant Architecture, Word Count Enforcement)
...
1. READ: ./skills/ads/A07-copy-production/A07-COPY-PRODUCTION-AGENT.md
2. READ: ./skills/ads/A07-copy-production/A07-COPY-PRODUCTION-ANTI-DEGRADATION.md
3. READ: ./skills/ads/AD-ENGINE-CLAUDE.md
...
ON EVERY A07 SESSION START:
  ...
  3. READ AD-ENGINE-CLAUDE.md (5 Laws, Variant Architecture, Word Counts)
...
Every microskill produces its own dedicated output file. This is MANDATORY. See CopywritingEngine CLAUDE.md for the universal protocol.
