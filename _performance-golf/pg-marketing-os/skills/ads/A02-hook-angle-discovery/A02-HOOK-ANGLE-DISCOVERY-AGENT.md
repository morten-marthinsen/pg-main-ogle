...
BEFORE ANY A02 EXECUTION:
  ...
  2. READ AD-ENGINE-CLAUDE.md (The 5 Laws, Hook vs Big Idea Distinction, A02 requirements)
...
|------------|------|---------|-------------|
| 0.0.1 | Vertical Profile Loader | Load ad-specific vertical config from `skills/ads/ad-verticals/` | `layer-0-outputs/0.0.1-vertical-profile.md` |
