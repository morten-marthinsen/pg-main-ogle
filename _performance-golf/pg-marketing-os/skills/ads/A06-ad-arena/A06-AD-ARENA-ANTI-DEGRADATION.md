...
**Authority:** This document has EQUAL authority to ENFORCEMENT-GATES.md, CLAUDE.md, and AD-ENGINE-CLAUDE.md
...
SESSION STARTUP:
  ...
  4. READ ARENA-CORE-PROTOCOL.md (3-round shared protocol)
...
[ ] AD-ENGINE-CLAUDE.md read (Ad Arena Adaptation section)
[ ] ARENA-CORE-PROTOCOL.md read (3-round shared protocol)
