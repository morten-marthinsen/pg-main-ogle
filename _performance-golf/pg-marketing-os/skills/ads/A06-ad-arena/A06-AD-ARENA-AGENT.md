...
- `./skills/protocols/ARENA-CORE-PROTOCOL.md` (Shared Arena protocol v2.0)
- `./skills/protocols/ARENA-PERSONA-PANEL.md` (CopywritingEngine persona panel — for structural reference)
...
BEFORE ANY A06 EXECUTION:
  ...
  3. READ: AD-ENGINE-CLAUDE.md (Ad Arena Adaptation section)
  4. READ: ARENA-CORE-PROTOCOL.md (shared protocol for 3-round structure)
...
1. READ: ./skills/ads/A06-ad-arena/A06-AD-ARENA-ANTI-DEGRADATION.md
2. READ: ./skills/ads/A06-ad-arena/A06-AD-ARENA-AGENT.md
...
**This is the CORE of A06. It follows the 3-round mandatory protocol from ARENA-CORE-PROTOCOL.md adapted for ad-specific personas and criteria.**
...
ad_persona_agent_package:
  ...
  # 5. Constraints
  effort_level: "max"
  anti_slop_rules: "[from AD-ENGINE-CLAUDE.md]"
...
BEFORE executing ANY A06 skill:
  ...
  3. READ: ARENA-CORE-PROTOCOL.md (shared protocol)
...
The Ad Arena (A06) adapts the CopywritingEngine Arena protocol (ARENA-CORE-PROTOCOL.md v2.0) for ad-specific evaluation. Key similarities and differences:
