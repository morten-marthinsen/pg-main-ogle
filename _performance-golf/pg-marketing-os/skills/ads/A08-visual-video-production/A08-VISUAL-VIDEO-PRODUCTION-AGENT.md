...
- `./skills/ads/A05-visual-direction/A05-VISUAL-DIRECTION-AGENT.md` (upstream visual briefs)
- `./skills/ads/A07-copy-production/A07-COPY-PRODUCTION-AGENT.md` (upstream final copy)
...
3. AD-ENGINE-CLAUDE.md (Ad Engine master constraints)
...
|------------|------|---------|-------------|
| 0.0.1 | Vertical Profile Loader | Load ad-specific vertical config from `skills/ads/ad-verticals/` for production constraints | `layer-0-outputs/0.0.1-vertical-profile.md` |
...
STEP 1: EXTRACT VOICE DIRECTION
  ...
  Extract:
    ...
    - Target duration (from script word count -- see AD-ENGINE-CLAUDE.md word count table)
...
BEFORE ANY A08 EXECUTION:
  ...
  3. READ AD-ENGINE-CLAUDE.md sections: Integration Architecture, A08 requirements
...
PRE-EXECUTION CHECKLIST:
  ...
  [ ] Read AD-ENGINE-CLAUDE.md Integration Architecture section
