...
**Inspiration:** Sam Woods recommendation + Anthony's revision pattern analysis
...
- **Specimens (positive):** 3-5 short excerpts (50-150 words each) that nail the voice. Can be from previous campaigns, reference material, or Anthony's own writing.
...
Pre-Strategic Review (Human)
  │
  ├─ Anthony adds positive specimens
  ├─ Anthony adds anti-specimens
...
Post-Campaign Learning
  │
  ├─ Anthony's edits analyzed against Soul.md predictions
