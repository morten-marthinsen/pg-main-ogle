...
This is a project-level enforcement file (NOT the global or engine CLAUDE.md). It MUST contain:
...
4. READ skills/foundation/01-research/RESEARCH-ANTI-DEGRADATION.md
5. READ skills/foundation/01-research/RESEARCH-PRD.md (Sections 1-3 minimum)
