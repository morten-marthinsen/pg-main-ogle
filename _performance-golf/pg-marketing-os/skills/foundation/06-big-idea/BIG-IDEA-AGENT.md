...
**RSF Dependencies (Required):** expectation_schema.json, latent_resonance_field.json (including FSSIT candidates), FSSIT-RANKING.md (standardized handoff from `skills/protocols/FSSIT-HANDOFF-TEMPLATE.md`)
...
BEFORE ANY BIG IDEA SKILL EXECUTION:
  ...
  2. READ skills/protocols/SOUL-MD-PROTOCOL.md (voice/taste constraint system)
