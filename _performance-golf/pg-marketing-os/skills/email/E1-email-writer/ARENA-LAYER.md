...
> **Arena Mode:** `generative_full_draft` -- Competitors write COMPLETE emails from scratch using upstream packages and structural specimens. Layer 2 draft = reference material, not template. See `ARENA-CORE-PROTOCOL.md` for 3-round execution protocol.
