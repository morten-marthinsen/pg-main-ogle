...
|-----------|------|-----------------|
| **Arena Protocol** | `skills/ARENA-CORE-PROTOCOL.md` | 7-competitor, 3-round competition framework |
| **Persona Panel** | `skills/ARENA-PERSONA-PANEL.md` | 6 persona specifications + The Architect + The Critic |
...
| **Persona Voice Loading** | `skills/protocols/PERSONA-VOICE-LOADING-PROTOCOL.md` | System 2 specimen loading |
| **Taste Capture** | `skills/protocols/TASTE-CAPTURE-PROTOCOL.md` | Structured edit learning |
| **Learning Capture** | `skills/protocols/LEARNING-CAPTURE-PROTOCOL.md` | Continuous improvement loop |
| **MC-CHECK** | `./CLAUDE.md` | Metacognitive checkpoint protocol |
| **Vertical Profiles** | `skills/verticals/` | Niche-specific configuration |
...
**Inherits from:** `skills/ARENA-CORE-PROTOCOL.md`
...
Location: `skills/email/specimens/`
...
Location: `skills/persona-specimens/` (shared with main CopywritingEngine)
...
Location: `skills/email/shared/transition-phrase-library.md`
...
Location: `skills/email/shared/cta-pattern-library.md`
...
Location: `skills/email/shared/urgency-mechanism-library.md`
...
Location: `skills/email/shared/niche-adaptation-guide.md`
...
Location: `skills/email/shared/email-quality-rubric.md`
...
Location: `skills/email/templates/launch-sequence.md`
...
Location: `skills/email/templates/autoresponder-series.md`
...
Location: `skills/email/templates/daily-relationship.md`
...
Location: `skills/email/templates/affiliate-promotion.md`
...
Location: `skills/email/templates/content-series.md`
...
Location: `skills/email/templates/one-off-promotional.md`
...
Inherits full MC-CHECK from `./CLAUDE.md`. Adds email-specific checks:
...
Inherits the full anti-slop list from `./CLAUDE.md`. Adds email-specific patterns:
