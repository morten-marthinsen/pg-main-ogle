...
> - See `ARENA-CORE-PROTOCOL.md` for complete 3-round execution protocol
...
2. Load ARENA-CORE-PROTOCOL.md for 3-round execution flow
...
**GATE_2.5 (HUMAN_SELECT):** Human explicitly selects winning upsell page. FAIL if: no selection made OR all candidates below 8.0 threshold (trigger all-below-threshold protocol per ARENA-CORE-PROTOCOL.md).
...
| All Arena candidates below 8.0 | GATE_2.5 | Follow all-below-threshold protocol per ARENA-CORE-PROTOCOL.md | Human decides: accept highest, regenerate, or adjust upstream |
