...
- [MANDATORY THREAD ELEMENTS (from UPSELL-ENGINE-CLAUDE.md)](#mandatory-thread-elements-from-upsell-engine-claudemd)
...
## MANDATORY THREAD ELEMENTS (from UPSELL-ENGINE-CLAUDE.md)
