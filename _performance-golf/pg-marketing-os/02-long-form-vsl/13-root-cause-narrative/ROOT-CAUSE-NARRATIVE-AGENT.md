...
1. `13-root-cause-narrative/ARENA-LAYER.md` — skill-specific criteria and weights
...
**Source:** `tier1-extractions/DeepAnalysisProtocol/outputs/root-cause-narrative-intelligence.md`
