...
**Authority:** This protocol has EQUAL authority to ~system/protocols/ARENA-CORE-PROTOCOL.md and ~system/SYSTEM-CORE.md.
...
## Integration with ~system/protocols/ARENA-CORE-PROTOCOL.md
...
## Cross-Round Diversity (Inter-Round Layer)

This protocol handles WITHIN-round diversity (pairwise convergence checks within a single round). For BETWEEN-round diversity — preventing self-few-shotting across rounds — see the **Controlled Inter-Round Diversity** section in `~system/protocols/ARENA-CORE-PROTOCOL.md`.
