...
```
I HAVE READ THIS FILE: EC-01-ANTI-DEGRADATION.md v1.0
...
```
PRE-EXECUTION:
[ ] EC-01-ANTI-DEGRADATION.md read (THIS FILE)
[ ] EC-01-AGENT.md read
...
[ ] Downstream handoffs populated (EC-02, EC-03, EC-04)
