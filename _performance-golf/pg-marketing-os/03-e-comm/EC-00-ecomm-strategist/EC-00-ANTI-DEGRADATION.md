...
- AI does not define feature research scope, leaving EC-01 directionless
...
- Body copy sentences
- Feature descriptions (save for EC-01)
- Value propositions (save for EC-02)
- Section copy (save for EC-03)
...
### The Problem
AI produces strategy without defining what features EC-01 should investigate. EC-01 then guesses at feature scope, producing irrelevant naming.
...
feature_scope_check:
  ...
  IF total_candidates < 4:
    HALT -- "Feature research scope too thin for EC-01"
```
...
| "Feature scope will emerge in EC-01" | EC-01 needs direction from strategy | HALT -- Define scope now |
...
```
PRE-EXECUTION:
[ ] EC-00-ANTI-DEGRADATION.md read (THIS FILE)
[ ] EC-00-AGENT.md read
...
[ ] Downstream handoffs populated (EC-01 through EC-05 references)
