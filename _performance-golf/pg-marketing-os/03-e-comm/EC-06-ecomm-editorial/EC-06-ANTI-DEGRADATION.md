...
```
I HAVE READ THIS FILE: EC-06-ANTI-DEGRADATION.md v1.0
...
- AI renames features during revision ("improving" EC-01 names)
...
### The Problem
AI rewrites entire sections during editorial, losing the voice and approach selected during Arena phases in EC-02/EC-03.
...
```yaml
feature_name_lock:
  EC-01 feature names are FINAL.
  Editorial CANNOT rename features.
  Editorial CANNOT add new feature names.
  Editorial CAN only correct inconsistent usage to match EC-01.
...
```yaml
proof_preservation:
  Proof elements from EC-03 CANNOT be removed during editorial.
...
| "This feature name could be better" | Feature names are locked by EC-01 | DO NOT change names |
