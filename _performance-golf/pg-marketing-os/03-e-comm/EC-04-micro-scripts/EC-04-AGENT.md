...
> **Dependencies:** EC-00-ecomm-strategist, EC-01-feature-naming, EC-03-section-copy
...
- Feature names from EC-01 used consistently
...
**Downstream:** Feeds `micro-scripts.json` to EC-05 (Assembly)
...
2. **Feature consistency:** Exact EC-01 names in scripts.
...
| Feature name wrong | Correct to exact EC-01 name |
