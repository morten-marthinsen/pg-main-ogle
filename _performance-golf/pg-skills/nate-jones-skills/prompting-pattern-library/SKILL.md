...
**📖 Full Documentation**: See [README.md](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/README.md) for complete navigation, use case index, and version notes.

**Quick access by need:**
- **Learning prompting**: Start here, then read [Prompt Patterns](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md)
- **Debugging prompts**: Jump to [Failure Modes](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/failure-modes.md)
- **Building agents**: See [Orchestration Patterns](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/orchestration-patterns.md)
- **Model optimization**: Review [Model Quirks](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/model-quirks.md)
