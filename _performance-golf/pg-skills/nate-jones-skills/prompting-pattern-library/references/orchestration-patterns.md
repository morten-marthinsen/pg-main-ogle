...
**Prerequisites**: Familiarity with [foundational patterns](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md), particularly chain-of-thought and structured output.
...
**Cross-reference**: Uses [structured output](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#4-json-output-specification) and [role assignment](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#7-expert-role-assignment) patterns.
...
**Cross-reference**: Combines [reflection](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#12-reflection-and-self-critique) with iterative execution.
...
**Cross-reference**: Planner uses [hierarchical breakdown](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#15-hierarchical-task-breakdown), executor uses domain-specific patterns.
...
**Cross-reference**: Each specialist uses appropriate [role assignment](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#7-expert-role-assignment) and domain patterns.
...
**Cross-reference**: Uses [reflection pattern](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#12-reflection-and-self-critique) but separates roles for stronger critique.
...
**Cross-reference**: Similar to [self-consistency](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#10-self-consistency) but with explicit comparison logic.
...
**Cross-reference**: Tool selector uses [chain-of-thought](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#3-chain-of-thought-cot) for planning.
...
**Cross-reference**: Uses [structured output](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#4-json-output-specification) for call planning.
...
**Cross-reference**: State manager uses [structured output](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md#4-json-output-specification) for state representation.
...
**Cross-reference**: Combines multiple patterns from this document with foundational patterns from [prompt-patterns.md](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/prompt-patterns.md).
