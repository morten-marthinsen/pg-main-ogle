...
**When it fails**: See [Ambiguity Failures](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/failure-modes.md#ambiguity-failures) if output format unclear, or [Assumption Failures](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/failure-modes.md#assumption-failures) if context insufficient.

**Model notes**: All major models (Claude, GPT-4, Gemini) handle zero-shot well for common tasks. See [Model Quirks](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/model-quirks.md) for model-specific optimization.
...
**When it fails**: See [Reasoning Failures](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/failure-modes.md#reasoning-failures) section on "Insufficient Example Diversity" if model struggles with variations not shown in examples.
...
See [Model Quirks](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/model-quirks.md) for detailed guidance.
...
**When it fails**: If reasoning goes off track, see [Reasoning Failures](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/failure-modes.md#reasoning-failures). For multi-step tasks requiring orchestration, see [Planner-Executor Pattern](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/orchestration-patterns.md#3-planner-executor-pattern).
...
For detailed model guidance, see [Model Quirks](_Performance%20Golf/pg-skills/nate-jones-skills/prompting-pattern-library/references/model-quirks.md).
