# PG1 Welcome Video Script

**Voice:** Brixton Albert (CEO, 11 Labs AI voice)
**Format:** Loom screen-share walkthrough of Figma dashboard
**Length:** ~90–120 seconds
**Structure:** Two intros (new vs. returning) that merge into one shared walkthrough
**Goal:** Orient users to the PG1 Pulse Smart Path
...
## Intro 2 — Returning Customers

Hey, it's Brixton Albert.

Welcome back to Performance Golf.

Now, I know it looks different since the last time you logged in...

So I want to start by saying you still have access to ALL your content.
...
*Estimated duration: ~100 seconds at natural Loom walkthrough pace*
