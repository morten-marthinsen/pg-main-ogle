"""One-time Google Docs OAuth setup script.

Runs the OAuth flow to get a refresh token for Docs read-only access.
...
Usage: python3 setup/docs_auth.py
"""
...
TOKEN_PATH = os.path.join(AUTH_DIR, "docs_token.json")
...
def main():
    ...
    print("\nGoogle Docs OAuth setup complete! (scope: documents.readonly)")
